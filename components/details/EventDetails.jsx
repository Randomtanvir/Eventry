    ...
    <div className="col-span-3">
      <div className="w-full h-full bg-[#242526] p-6 rounded-lg">
        ...
        <div className="my-2 text-[#AEAEAE] space-y-4 prose lg:prose-lg max-w-none">
          <p className="">
            If you&lsquo;re passionate about data, coding, and everything
            tech-related, this is an event you won&lsquo;t want to miss. Whether
            you&lsquo;re a seasoned developer or just getting started, join us
            to discuss the latest trends in data analysis, programming, and
